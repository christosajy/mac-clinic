# Generated by Django 5.2.3 on 2025-06-24 12:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.appointment')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
            name='DoctorId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.doctor'),
        ),
        migrations.CreateModel(
            name='LabTest',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('LabTestCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.labtestcategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.appointment')),
                ('LabTestId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.labtest')),
            ],
        ),
        migrations.CreateModel(
            name='Medicine',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MedicineCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.medicinecategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.appointment')),
                ('MedicineId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.medicine')),
            ],
        ),
        migrations.CreateModel(
            name='MedicineStock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MembershipId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.membership')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
            name='PatientId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.patient'),
        ),
        migrations.AddField(
            model_name='doctor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('RoleId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminapp.role')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
            name='StaffId',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='adminapp.staff'),
        ),
    ]
